...
class Test {
    public static void main(String[] args) {
        Test test = new Test();
        int[][] red_edges = new int[][] {{5,5},{4,6},{6,4},{4,1},{4,3},{2,3},{1,1},{1,6},{0,6},{0,2},{1,5},{6,0}};
        int[][] blue_edges = new int[][]{{1,1},{5,2},{4,0},{5,5},{2,4},{4,2},{0,4},{0,5},{3,5},{1,2},{6,2},{0,6},{3,1},{5,0}};
        int n = 7;
