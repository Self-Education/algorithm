public class AmazonOA2 {
    class AmazonOA {
        ...
        // 就是给的road是重复的
        // 题目意思是有一定数量的城市，城市之间已经有了一些道路。还有一些可以供选择的道路来建设。每个新建的道路有 cost。问如果要连接所有的城市，新建路的最小的
        // cost 是多少。举个栗子：
        // Input 如下：
        ...
        // eg. N = 3, M = 2, List<List<Ingeter>> 是 [[2,3][3,4],[1,-3]] output:
        // [[2,3],[1,-3]]
        ...
        // 5. robot removes 障碍
        // 9 is obstacle, 1 flat lot can move, 0 trenches can't move. Find the minimum
        // val to reach obstacle in order to remove it
        // e.g.
        // [1,1,1]
        // [1,0,0]
        // [1,9,1]
        ...
        // - 给一个去程route的list和一个回城route的list，还有一个来回路程的上限max。求来回路程最接近于max的route
        // combination。
        ...
        // 7. 卡车装箱 (TWO SUM)
        // e.g. truck capacity - 90 / reserved capacity - 30 / paCkage capacities - [10,
        // 25, 35, 60]
        // 要求返回 [1, 2] (25和35的索引)
