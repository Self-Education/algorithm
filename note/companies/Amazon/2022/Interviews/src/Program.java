...
public class Program {
    ...
    private static void flipCoin(Solution solution) {
        System.out.println("Expected answer is " + 1 + "; Output is "
                + solution.flipCoin("HHTHTT"));
    }

    // 3
    private static void shipPackages(Solution solution) {

    }

    // 4
    private static void optimizeUtilization(Solution solution) {

    }

    // 5
    private static void wheelCipher(Solution solution) {

    }

    // 6
    private static void decodeString(Solution solution) {

    }

    // 7
    private static void treeHeights(Solution solution) {
        System.out.println("Expected answer is " + 12 + "; Output is "
    ...
    // 8
    private static void splitIntToPrimes(Solution solution) {

    }

    // 9
    private static void numberGameGCD(Solution solution) {

    }

    // 10
    private static void arrangeKeypad(Solution solution) {

    }

    private static void maxCumulativeObservableSum(Solution solution) {
        System.out.println("Expected answer is " + 14 + "; Output is "
                + solution.maxCumulativeObservableSum(new int[] { 1, 2, 7, 7, 4, 3, 6 }, 3));
        System.out.println("Expected answer is " + 18 + "; Output is "
                + solution.maxCumulativeObservableSum(new int[] { 4, 4, 8, 6, 6, 7, 4 }, 3));
        System.out.println("Expected answer is " + 0 + "; Output is "
                + solution.maxCumulativeObservableSum(new int[] { 6, 6, 6, 6, 6, 6 }, 3));
    }

    private static void commonPrefix(Solution solution) {
    ...
    private static void subarrayWithAtMostKOdds(Solution solution) {
        System.out.println("Expected answer is " + 7 + "; Output is "
        ...
        System.out.println("Expected answer is " + 18 + "; Output is "
                + solution.subarrayWithAtMostKOdds(new int[] { 2, 2, 5, 6, 9, 2, 11, 9, 2, 11, 12 }, 1));
    }

    private static void countAZ(Solution solution) {
        System.out.println("Expected answer is " + 2 + "; Output is "
    ...
    private static void deliverBoxes(Solution solution) {
        System.out.println("Expected answer is " + 4 + "; Output is "
                + solution.deliverBoxes(new int[] { 2, 2, 3, 3, 2, 4, 4, 4, 4, 4 }));
        System.out.println("Expected answer is " + -1 + "; Output is "
